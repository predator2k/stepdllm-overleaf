\begin{table}[H]
  \centering
  \caption{Kernel-level efficiency of \name sparse attention. Wall-clock time (ms) for a single attention forward pass at various sequence lengths and sparsity levels. Speedup is computed relative to the dense baseline.}
