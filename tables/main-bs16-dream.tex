\begin{table}[t]
  \centering
  \caption{Comprehensive Benchmark Results on Dream-7B-Instruct}
  ...
  \resizebox{\textwidth}{!}{%
    ...
    \toprule
    \multirow{2}{*}{Method} & \multirow{2}{*}{Sparsity} & \multirow{2}{*}{GSM8K} & \multirow{2}{*}{Math} & \multirow{2}{*}{HumanEval}
    ...
    Dense & -- & \textbf{77.41\%} & \textbf{45.60\%} & --
      & \textbf{100.00\%} & \textbf{100.00\%} & \textbf{91.00\%} & \textbf{98.00\%}
    ...
    \multirow{4}{*}{SparseD}
      ...
      & \textbf{100.00\%} & \textbf{100.00\%} & 90.20\% & \textbf{98.00\%} & 99.40\% & \textbf{75.80\%}
      & \textbf{97.45\%} & 97.40\%
      & 96.28\% & \textbf{85.16\%} & \textbf{75.80\%} & 80.37\% & \textbf{64.60\%} \\
    & 80\% & 49.81\% & 37.80\% & 53.66\%
      & \textbf{100.00\%} & \textbf{99.80\%} & 47.20\% & \textbf{98.80\%} & \textbf{99.80\%} & 46.80\%
      & 60.05\% & 69.30\%
      & 95.44\% & 71.76\% & \textbf{71.77\%} & \textbf{79.50\%} & 61.00\% \\
    & 90\% & 22.21\% & 28.80\% & 43.90\%
      & \textbf{100.00\%} & \textbf{100.00\%} & 44.60\% & \textbf{98.80\%} & \textbf{99.80\%} & \textbf{44.80\%}
      & \textbf{59.45\%} & \textbf{69.00\%}
      & 92.20\% & 54.72\% & 67.53\% & 78.45\% & \textbf{61.60\%} \\
    & 95\% & 4.40\% & 14.80\% & 31.10\%
      & \textbf{100.00\%} & \textbf{100.00\%} & \textbf{40.80\%} & \textbf{98.40\%} & 99.40\% & \textbf{37.40\%}
