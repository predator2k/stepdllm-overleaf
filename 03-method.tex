...
\begin{figure}[h]
    ...
    \caption{Attention Pattern across different steps}
    \label{fig:attention_pattern_across_steps}
\end{figure}

% \begin{figure}[t] % t 表示放在页面顶部
%   \centering
%   % 第一张子图
%   \begin{subfigure}[b]{0.15\textwidth}
%     \centering
%     \includegraphics[width=\textwidth]{figures/step_001.png}
%     \caption{Attention.}
%     \label{fig:attention_matrix}
%   \end{subfigure}
%   % \hfill % 在两张图之间插入弹性间距，使其撑满行宽
%   % 第二张子图
%   \begin{subfigure}[b]{0.15\textwidth}
%     \centering
%     \includegraphics[width=\textwidth]{figures/step_016.png}
%     \caption{Attention }
%     \label{fig:sparsity_budget}
%   \end{subfigure}
%   \begin{subfigure}[b]{0.15\textwidth}
%     \centering
%     \includegraphics[width=\textwidth]{figures/step_032.png}
%     \caption{Attention }
%     \label{fig:sparsity_budget}
%   \end{subfigure}
%   \begin{subfigure}[b]{0.15\textwidth}
%     \centering
%     \includegraphics[width=\textwidth]{figures/step_048.png}
%     \caption{Attention }
%     \label{fig:sparsity_budget}
%   \end{subfigure}
%   \begin{subfigure}[b]{0.15\textwidth}
%     \centering
%     \includegraphics[width=\textwidth]{figures/step_064.png}
%     \caption{Attention }
%     \label{fig:sparsity_budget}
%   \end{subfigure}
  
%   \caption{Comparison of attention mechanisms in Step-Dllm.}
...
\begin{figure}[t] % 去掉 *，使其回归单栏
    ...
    \begin{subfigure}[b]{0.49\columnwidth}
        ...
        \caption{The difference of Attention Sparsity Budget Between different heads.}
...
% \begin{figure}[h]
%     \centering
%     \includegraphics[width=0.5\linewidth]{figures/placeholder.pdf}
%     % \vspace{-2em} % 调整图和caption之间的距离
%     \caption{main figure}
%     \label{fig:p}
% \end{figure}
