\begin{table}[t]
\centering
\caption{Ablation on mask refresh frequency (LLaDA-1.5, block size 16). Frequency $f$ means the mask is refreshed every $f \times N_{\text{steps}}$ steps; lower $f$ corresponds to more frequent updates. \textbf{Bold} marks the best per sparsity level.}
...
\toprule
\multirow{2}{*}{Sparsity} & \multirow{2}{*}{Metric} & \multicolumn{4}{c}{SparseD} & \multicolumn{4}{c}{Step-dLLM} \\
\cmidrule(lr){3-6} \cmidrule(lr){7-10}
& & $f{=}1.0$ & $f{=}0.5$ & $f{=}0.3$ & $f{=}0.2$ & $f{=}1.0$ & $f{=}0.5$ & $f{=}0.3$ & $f{=}0.2$ \\
\midrule
