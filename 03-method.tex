...
SparseD emphasizes that sparse patterns are highly reusable across denoising steps and therefore pre-computes sparse patterns once and reuses them later, while other methods leverage the temporal stability of token saliency to evict low-importance cache entries. 
